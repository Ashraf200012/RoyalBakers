...
for x in myresult:
    tr_html+=f"""
    <tr>
                                        <th scope="row"><a href="FlavourDelete.py?id={x[0]}"><button class="btn-delete">Delete</button></a>
                                        <a href="FlavourEdit.py?id={x[0]}"><button class="btn-change">Change</button></a></th>
                                            <th scope="row">{x[0]}</th>
                                            <td>{x[1]}</td>
                                            <td>{x[2]}</td>
